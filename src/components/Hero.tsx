...
export const Hero = () => {
	return (
		<div className='bg-[var(--color-cloud-white)] text-[var(--color-deep-blue)] bg-[linear-gradient(to_bottom,var(--color-cloud-white),var(--color-purple-very-light)_25%,var(--gradient-purple-1)_45%,var(--gradient-purple-2)_65%,var(--color-sky-blue)_90%)] py-[72px] sm:py-24 relative overflow-clip'>
			...
			<div className='container relative'>
				...
				<div className='flex justify-center'>
					<p className='text-center text-xl mt-8 max-w-md'>
						Track applications, celebrate wins, and turn your job
						search from chaos into progress with a simple, powerful
						tool built for modern job seekers.
					</p>
				</div>
				<div className='flex justify-center mt-8'>
