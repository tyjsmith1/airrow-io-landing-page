...
const SAMPLE_POSTS: BlogPost[] = [
	{
		...
		excerpt:
			'Learn effective strategies to organize and monitor your job search process...',
		author: {
			name: 'Jane Doe',
	...
	},
	{
		...
		excerpt:
			'Discover the key metrics and insights that lead to landing your dream job...',
		author: {
			name: 'John Smith',
	...
	},
	{
		...
		excerpt:
			"Don't let these errors cost you your dream job. Learn how to sidestep them...",
		author: {
			name: 'Emily Johnson',
	...
	},
	{
		...
		excerpt:
			'Discover how staying organized can significantly boost your job search success...',
		author: {
			name: 'Michael Brown',
	...
	},
	{
		...
		excerpt:
			'Learn how to leverage data to improve your application strategy and success rate...',
		author: {
			name: 'Sarah Lee',
	...
	},
	{
		...
		excerpt:
			'Understand the science behind effective follow-ups and how to use it to your advantage...',
		author: {
			name: 'David Wilson',
