...
const SAMPLE_POST: BlogPostFull = {
	...
	excerpt:
		'Learn effective strategies to organize and monitor your job search process for maximum success.',
	author: {
		name: 'Jane Doe',
  ...
  `,
	tableOfContents: [
		{
			title: 'The Importance of Tracking Your Job Applications',
			anchor: 'importance-of-tracking',
		},
		{
			title: 'Tools for Tracking Your Job Search',
			anchor: 'tools-for-tracking',
		},
		{ title: 'What Information to Track', anchor: 'what-to-track' },
		{ title: 'Follow-up Strategies', anchor: 'follow-up-strategies' },
		{
			title: 'Analyzing Your Application Data',
			anchor: 'analyzing-your-data',
		},
	],
};
		...
		<div>
			...
			<main className='min-h-screen'>
                ...
                border-gray-200 dark:border-gray-800'
								...
								<ShareButtons
									url={`https://hireground.app/blog/${post.slug}`}
									title={post.title}
								/>
